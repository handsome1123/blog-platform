    ...
    <section className="social-showcase">
      <div className="container">
        ...
        <div className="social-links">
          <a href="https://www.youtube.com/your_channel_link" className="social-btn youtube" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.tiktok.com/@YOUR_HANDLE" className="social-btn tiktok" target="_blank" rel="noopener noreferrer">
